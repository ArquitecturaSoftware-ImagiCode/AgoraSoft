        ...
        try {
            ...
            RequestState requestState = AuthenticateRequest.authenticateRequest(
                    ...
                    AuthenticateRequestOptions
                            ...
                            .authorizedParties(Arrays.asList("http://10.43.103.209", "http://localhost:8080", "http://localhost:4200","http://localhost:8085", "http://127.0.0.1", "http://10.43.102.15","https://agorasoft.ngrok.app","http://localhost:30080","http://127.0.0.1:4040","https://agorasoftqa.ngrok.app"))
                            .build()
            );
